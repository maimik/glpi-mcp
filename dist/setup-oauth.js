...
async function main() {
    ...
    console.log('3. **IMPORTANT**: Add "http://localhost:3999/callback" to the "Redirect URIs".');
    ...
    const server = http.createServer(async (req, res) => {
        ...
        if (url.pathname === '/callback') {
            ...
            if (code) {
                ...
                try {
                    const tokenResponse = await axios.post(`${glpiUrl}/plugins/oauth2/index.php/token`, new URLSearchParams({
...
main();
//# sourceMappingURL=setup-oauth.js.map